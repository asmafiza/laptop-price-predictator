...
Original file is located at
    https://colab.research.google.com/drive/1t14kuYG-ijdjDRhK0BWhDhmp3b4mrcW-
"""
...
print((X_train == '').sum())
X_train['HDD'] = X_train['HDD'].replace('', 0).astype(float)
X_train['SSD'] = X_train['SSD'].replace('', 0).astype(float)

X_test['HDD'] = X_test['HDD'].replace('', 0).astype(float)
X_test['SSD'] = X_test['SSD'].replace('', 0).astype(float)
